...
const PERMISSION_LABELS: Record<string, { label: string; group: string; icon: "event" | "task" | "manage" | "visibility" }> = {
    ...
    "project:event_treasury_target": { label: "Convocado a reuniones de tesorería", group: "Eventos", icon: "event" },
    ...
    "project:resource_create": { label: "Crear recursos", group: "Tareas", icon: "task" },
    "project:resource_edit_own": { label: "Editar recursos propios", group: "Tareas", icon: "task" },
    "project:resource_edit_any": { label: "Editar cualquier recurso", group: "Tareas", icon: "task" },
    "project:resource_delete_own": { label: "Eliminar recursos propios", group: "Tareas", icon: "task" },
    "project:resource_delete_any": { label: "Eliminar cualquier recurso", group: "Tareas", icon: "task" },
    "project:resource_view_all": { label: "Ver recursos de todas las áreas", group: "Visibilidad", icon: "visibility" },

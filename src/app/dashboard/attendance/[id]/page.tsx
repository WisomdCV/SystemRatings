...
export default async function DashboardAttendancePage({ params }: AttendancePageProps) {
    ...
    if (!event) {
        return (
            <div className="p-10 text-center">
                ...
                <Link href="/dashboard/agenda" className="text-blue-500 hover:underline mt-4 block">Volver a agenda</Link>
            </div>
        );
    }
    ...
    if (!success || !data) {
        return (
            <div className="p-10 text-center">
                ...
                <Link href="/dashboard/agenda" className="text-blue-500 hover:underline mt-6 block font-bold">Volver a agenda</Link>
            </div>
        );
    }
